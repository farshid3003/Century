...
namespace Century.Services.IdentityService.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        public UserInfoViewModel GetUserInfo()
        {
            ...
            var a = new Microsoft.AspNet.Owin.OwinEnvironment(Request.HttpContext);

            return new UserInfoViewModel
            {
                Email = User.Identity.Name,
                HasRegistered = false,// externalLogin == null,
                LoginProvider = null //externalLogin != null ? externalLogin.LoginProvider : null
            };
        }
